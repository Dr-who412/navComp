...
var card2:CardView=itemView.findViewById(R.id.cardView6)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.card2.setOnClickListener {
            var action = BlankFragment_1Directions.actionBlankFragment1ToBlankFragment2(list.name,list.description,list.image_url)
